...
export const sichotProducts: Record<string, Product> = {
  'sichos-haran': {
    ...
    nameSpanish: 'Conversaciones de Rabí Najmán',
    ...
    descriptionFrench: '"Au début, je pensais qu\'il fallait seulement écrire les enseignements de notre Maître", raconta Rabbi Nathan, "mais avec le temps, j\'ai compris que chaque conversation de sa part devait être mise par écrit". Le livre \'Sichos Haran\' contient des conversations tenues par notre Maître lors de voyages et en chemin, et à diverses occasions, pas nécessairement à la table du Chabbat ou devant une assemblée de \'Hassidim.',
    descriptionSpanish: '"Al principio pensé que solo las enseñanzas de nuestro Maestro debían escribirse", contó Rabí Natán, "pero con el tiempo comprendí que cada conversación suya debía ponerse por escrito". El libro \'Sichos Haran\' contiene conversaciones mantenidas por nuestro Maestro durante viajes y en el camino, y en diversas ocasiones, no necesariamente en la mesa de Shabat o ante una asamblea de Jasidim.',
    descriptionRussian: '«Сначала я думал, что нужно записывать только учения нашего Учителя», — рассказывал рабби Натан, — «но со временем я понял, что каждая его беседа должна быть записана». Книга «Сихот а-Ран» содержит беседы, которые наш Учитель вел во время путешествий и в дороге, а также в различных случаях, не обязательно за субботним столом или перед собранием хасидов.',
