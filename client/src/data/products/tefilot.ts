...
export const tefilotProducts: Record<string, Product> = {
  ...
  'tehilim': {
    ...
    descriptionFrench: '"Celui qui veut mériter le repentir - qu\'il soit habitué à la récitation des Psaumes, car la récitation des Psaumes est propice au repentir", révèle notre saint Maître Rabbi Nachman (Likouteï Moharan I, 73). Édition spéciale, avec des lettres grandes et claires, avec les Likouteï Halakhot de Rabbi Nathan sur la page, selon l\'ordre des Psaumes.',
    descriptionSpanish: '"Quien quiera merecer el arrepentimiento - que se acostumbre a recitar los Salmos, porque la recitación de los Salmos es propicia para el arrepentimiento", revela nuestro santo Maestro Rabí Najmán (Likutei Moharan I, 73). Edición especial, con letras grandes y claras, con los Likutei Halajot de Rabí Natán en la página, según el orden de los Salmos.',
    descriptionRussian: '«Тот, кто хочет удостоиться покаяния - пусть привыкнет читать Псалмы, ибо чтение Псалмов способствует покаянию», - раскрывает наш святой Учитель Рабби Нахман (Ликутей Моаран I, 73). Специальное издание с крупными, четкими буквами, с Ликутей Алахот от Рабби Натана на странице, в соответствии с порядком Псалмов.',
