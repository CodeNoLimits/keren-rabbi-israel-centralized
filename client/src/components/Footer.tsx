      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontWeight: '600', color: '#FF6B35', fontSize: '1rem', marginBottom: '0.5rem' }}>
              {t.mission}
            </p>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <li>
                <a
                  ...
                  style={{ color: '#25D366', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '500', transition: 'color 0.2s' }}
